/* eslint-disable max-lines -- context 面板聚合 Context window 用量与明细展示。 */
...
/** 本地上下文窗口计量（BYOK：仅展示本地 token 计量，无厂商额度段）。 */
export function ChatContextUsage({
  ...
  return (
    ...
    >
      {/* span 包一层保持 inline-flex 收缩语义；ContextTrigger 是 HoverCard 触发器。 */}
