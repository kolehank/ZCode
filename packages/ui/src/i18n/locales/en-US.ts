...
const enUS: Record<string, string> = {
  ...
  "chat.officeSuggestions.heading": "Suggested tasks",
  ...
  "settings.remoteAccess.webServerOnly":
    "Remote access is served by the web server (zcode-server HTTP entry). Not available in the desktop app.",
  "settings.remoteAccess.loadFailed": "Failed to load remote access config",
  "settings.remoteAccess.loading": "Loading remote access config…",
  "settings.remoteAccess.mode.label": "Authentication mode",
  "settings.remoteAccess.mode.description":
    "Changes take effect after restarting the server; open mode always binds 127.0.0.1.",
  "settings.remoteAccess.mode.open": "Open (loopback only)",
  "settings.remoteAccess.mode.cloudflareAccess": "Cloudflare Access",
  "settings.remoteAccess.mode.token": "Access token",
  "settings.remoteAccess.cf.teamDomain": "Cloudflare team domain",
  "settings.remoteAccess.cf.aud": "AUD tag",
  "settings.remoteAccess.cf.emails": "Allowed emails (optional)",
  "settings.remoteAccess.cf.emailsDescription":
    "Comma separated; leave empty to allow every user of the Cloudflare Access application.",
  "settings.remoteAccess.cf.requiredError":
    "Cloudflare Access requires a team domain and an AUD tag",
  "settings.remoteAccess.token.title": "Access token",
  "settings.remoteAccess.token.prefix": "Current token prefix",
  "settings.remoteAccess.token.none": "No access token yet; one will be generated on save.",
  "settings.remoteAccess.token.generate": "Generate token",
  "settings.remoteAccess.token.regenerate": "Regenerate",
  "settings.remoteAccess.baseUrl.section": "External base URL",
  "settings.remoteAccess.interface.label": "Network interface",
  "settings.remoteAccess.interface.pick": "Pick an interface to suggest an address",
  "settings.remoteAccess.interface.empty": "No usable interface found",
  "settings.remoteAccess.interface.suggested": "suggested",
  "settings.remoteAccess.port": "Server port",
  "settings.remoteAccess.baseUrl.label": "Base URL (visible and editable)",
  "settings.remoteAccess.baseUrl.description":
    "The interface dropdown suggests `http://<ip>:<port>`; you can also type a domain/proxy URL (e.g. https://xxx.ts.net). QR/link content = base URL + /#token=<token>.",
  ...
  "settings.remoteAccess.oneTime.hint":
    "The token is shown only once. Copy it now; the file keeps only the SHA-256 digest and prefix.",
  "settings.remoteAccess.oneTime.qr": "Scan to open",
  "settings.remoteAccess.copyToken": "Copy token",
  ...
  "settings.usageLedger.window.today": "Today",
  "settings.usageLedger.window.last7Days": "Last 7 days",
  "settings.usageLedger.window.all": "All time",
  "settings.usageLedger.byProvider": "By provider",
  "settings.usageLedger.byModel": "By model",
  "settings.usageLedger.column.provider": "Provider",
  "settings.usageLedger.column.model": "Model",
  "settings.usageLedger.column.requests": "Requests",
  "settings.usageLedger.column.input": "Input",
  "settings.usageLedger.column.output": "Output",
  "settings.usageLedger.column.reasoning": "Reasoning",
  "settings.usageLedger.column.cacheRead": "Cache read",
  "settings.usageLedger.column.cacheWrite": "Cache write",
  "settings.usageLedger.loading": "Reading local usage…",
  "settings.usageLedger.empty": "No model requests recorded in this window yet.",
  "settings.usageLedger.loadFailed": "Failed to read local usage; check the logs",
  "settings.usageLedger.refresh": "Refresh",
  "settings.usageLedger.localOnlyNote": "Recorded locally only; never uploaded.",
  "settings.usageLedger.unknownProvider": "Unknown provider",
  "settings.usageLedger.unknownModel": "Unknown model",
  ...
  "onboarding.dialog.description": "Finish initial setup and start your first session.",
  "onboarding.wizard.label": "Setup",
  ...
  "onboarding.welcome.helper":
    "Connect a model with your own API key (BYOK) and pick a workspace to get started, or skip and finish later in Settings.",
  ...
  "onboarding.stepDescription.workspace":
    "Confirm the workspace to use, or open another project folder.",
  "onboarding.stepDescription.provider":
    "Configure your own model API key (BYOK) — no cloud sign-in required.",
  "onboarding.stepDescription.finish":
    "Setup is complete. Start your first session whenever you like.",
  "onboarding.workspace.current": "Current workspace",
  "onboarding.workspace.pending": "Preparing the default workspace…",
  "onboarding.workspace.openOther": "Open another folder",
  "onboarding.workspace.helper":
    "A workspace is where ZCode reads files and runs commands; you can switch it any time in a session.",
  "onboarding.provider.title": "Connect your own model",
  "onboarding.provider.body":
    "ZCode connects to models with your own API key (BYOK): add an API key for your provider in the model settings. No vendor cloud sign-in or confirmation is required.",
  "onboarding.provider.openSettings": "Open model settings",
  ...
  "onboarding.finish.done": "Setup complete",
  "onboarding.finish.ready": "Pick a model and start your first session whenever you like.",
  ...
  "automations.keepAwakeBanner": "Keep your computer awake while ZCode is running a chat.",
