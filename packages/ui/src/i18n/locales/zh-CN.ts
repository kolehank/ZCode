...
const zhCN: Record<string, string> = {
  ...
  "chat.officeSuggestions.heading": "试试这些任务",
  ...
  "settings.remoteAccess.webServerOnly":
    "远程访问由 Web 服务端（zcode-server HTTP 入口）承载，桌面端设置不可用。",
  "settings.remoteAccess.loadFailed": "读取远程访问配置失败",
  "settings.remoteAccess.loading": "正在读取远程访问配置…",
  "settings.remoteAccess.mode.label": "鉴权模式",
  "settings.remoteAccess.mode.description":
    "改动保存后需重启 server 才会生效；开放模式下服务强制绑定 127.0.0.1。",
  "settings.remoteAccess.mode.open": "开放（仅本机回环）",
  "settings.remoteAccess.mode.cloudflareAccess": "Cloudflare Access",
  "settings.remoteAccess.mode.token": "访问令牌",
  "settings.remoteAccess.cf.teamDomain": "Cloudflare Team 域名",
  "settings.remoteAccess.cf.aud": "AUD 标签",
  "settings.remoteAccess.cf.emails": "允许的邮箱（可选）",
  "settings.remoteAccess.cf.emailsDescription":
    "逗号分隔；留空表示 Cloudflare Access 允许的全部用户。",
  "settings.remoteAccess.cf.requiredError": "Cloudflare Access 需要 Team 域名与 AUD 标签",
  "settings.remoteAccess.token.title": "访问令牌",
  "settings.remoteAccess.token.prefix": "当前令牌前缀",
  "settings.remoteAccess.token.none": "尚未生成访问令牌，保存后将自动生成。",
  "settings.remoteAccess.token.generate": "生成令牌",
  "settings.remoteAccess.token.regenerate": "重新生成",
  "settings.remoteAccess.baseUrl.section": "外部访问基址",
  "settings.remoteAccess.interface.label": "网卡选择",
  "settings.remoteAccess.interface.pick": "选择网卡生成建议地址",
  "settings.remoteAccess.interface.empty": "未发现可用网卡",
  "settings.remoteAccess.interface.suggested": "建议",
  "settings.remoteAccess.port": "服务端口",
  "settings.remoteAccess.baseUrl.label": "基址（可见可编辑）",
  "settings.remoteAccess.baseUrl.description":
    "网卡下拉生成 `http://<ip>:<端口>` 建议；也可手填域名/反代地址（如 https://xxx.ts.net）。链接内容 = 基址 + /#token=<令牌>。",
  ...
  "settings.remoteAccess.oneTime.hint":
    "令牌明文仅本次展示，请立即复制保存；文件中只保留 SHA-256 摘要与前缀。",
  "settings.remoteAccess.oneTime.qr": "扫码打开",
  "settings.remoteAccess.copyToken": "复制令牌",
  ...
  "settings.usageLedger.window.today": "今日",
  "settings.usageLedger.window.last7Days": "近 7 天",
  "settings.usageLedger.window.all": "累计",
  "settings.usageLedger.byProvider": "按 Provider",
  "settings.usageLedger.byModel": "按模型",
  "settings.usageLedger.column.provider": "Provider",
  "settings.usageLedger.column.model": "模型",
  "settings.usageLedger.column.requests": "请求次数",
  "settings.usageLedger.column.input": "输入",
  "settings.usageLedger.column.output": "输出",
  "settings.usageLedger.column.reasoning": "推理",
  "settings.usageLedger.column.cacheRead": "缓存读",
  "settings.usageLedger.column.cacheWrite": "缓存写",
  "settings.usageLedger.loading": "正在读取本地用量…",
  "settings.usageLedger.empty": "该时间窗内暂无模型请求记录。",
  "settings.usageLedger.loadFailed": "读取本地用量失败，请查看日志",
  "settings.usageLedger.refresh": "刷新",
  "settings.usageLedger.localOnlyNote": "仅本地记录，不上传。",
  "settings.usageLedger.unknownProvider": "未知 Provider",
  "settings.usageLedger.unknownModel": "未知模型",
  ...
  "onboarding.dialog.description": "完成初始设置，开始你的第一次会话。",
  "onboarding.wizard.label": "初始设置",
  ...
  "onboarding.welcome.helper":
    "使用自带 API Key 连接模型（BYOK），选择工作区后即可开始；也可先跳过，稍后在设置中完成。",
  "onboarding.welcome.skip": "跳过引导",
  "onboarding.step.workspace": "工作区",
  "onboarding.step.provider": "模型连接",
  ...
  "onboarding.stepDescription.workspace": "确认要使用的工作区，也可以打开其他项目文件夹。",
  "onboarding.stepDescription.provider": "配置你自己的模型 API Key（BYOK），无需登录任何云服务。",
  "onboarding.stepDescription.finish": "初始设置完成，随时可以开始第一次会话。",
  "onboarding.workspace.current": "当前工作区",
  "onboarding.workspace.pending": "正在准备默认工作区…",
  "onboarding.workspace.openOther": "打开其他文件夹",
  "onboarding.workspace.helper": "工作区是 ZCode 读取文件与执行命令的范围，可随时在会话中切换。",
  "onboarding.provider.title": "连接你自己的模型",
  "onboarding.provider.body":
    "ZCode 采用 BYOK（自带密钥）方式连接模型：在设置的模型页为你的厂商填写 API Key 即可，全程不需要登录或确认任何云服务。",
  "onboarding.provider.openSettings": "打开模型设置",
  ...
  "onboarding.finish.done": "初始设置完成",
  "onboarding.finish.ready": "选择一个模型，随时开始你的第一次会话。",
  ...
  "automations.keepAwakeBanner": "ZCode 运行会话时保持电脑唤醒。",
